...
public class Table_Pharmacien extends AbstractTableModel implements TableModelListener{
     List<Pharmaciens> listePharmacien = new ArrayList<Pharmaciens>();
     String []header = {"Id","Nom","Prénom","Référence","Login","Mot de Passe","E-Mail","Diplome","CIN","Date de Naissance","NumTel","Adresse","Code Postal","Etat","X",""};
    int i=0;
    Boolean chB=new Boolean(false);
    Object[][] data;
    
    public Table_Pharmacien(int v) { //remplissage de la liste des medicaments
     
        listePharmacien=new PharmaciensDAO().DisplayAllPharmaciens(v);
